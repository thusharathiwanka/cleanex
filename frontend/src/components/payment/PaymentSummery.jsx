        ...
        <div className="  py-10 w-2/6  bg-light-blue ">
                <div className=" ">
                    ...
                    <div className="overflow-y-auto  h-52   pb-1">
                        {OrderDetails.map((id,key)=>( <div className="grid grid-cols-2" key={key}>
                        <div className="mb-3">
                            <img alt="order1" className=" ml-20 inline-block w-20 h-20" src={imageURL + id.pack.src}  />
                        </div>
                       
                        <div className=" ml-3 pt-1">
                            <label className="text-white ">{id.pack.name}</label><br/>
                            <label className="text-white">Qt {id.quantity}</label><br/>
                ...
                <div className="relative px-5 divide-y pt-14">
                    ...
                    <div className="p-2 pl-4">
                        ...
                        <label className="absolute right-10 text-lg  text-white">LKR {subTotal}</label><br/>
                    ...
                    <div className="p-2 pl-4">
                        ...
                        <label className="text-lg absolute right-10 text-white">LKR {Total}</label>
                    </div>
